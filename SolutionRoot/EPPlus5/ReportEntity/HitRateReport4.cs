...
namespace EPPlus5Report.ReportEntity
{
    public class HitRateReport4 : BaseReportEntity
    {
        ...
        public HitRateReport4(IDictionary<string, object> _dataSetObj)
        {
            Console.WriteLine("Said \"Hello World!\" from HitRateReport4");
        ...
        public override void InitializateMainContent()
        {
            ...
            _templateDirectory = Path.Combine(this.templateBaseDirectory, @"HitRateReport4");
