...
namespace JasperReport.ReportEntity
{
    public class HitRateReport3 : BaseReportEntity
    {
        ...
        public HitRateReport3(IDictionary<string, object> _dataSetObj)
        {
            Console.WriteLine("Said \"Hello World!\" from HitRateReport3");
        ...
        public override void InitializateMainContent()
        {
            ...
            _templateDirectory = Path.Combine(this.templateBaseDirectory, @"HitRateReport3");
